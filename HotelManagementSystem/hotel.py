...
class HotelManagementSystem:
    def __init__(self,root):
        ...
        img1=Image.open("/home/amit/Desktop/HotelManagementSystem/hotel1.png")
        ...
        img5=Image.open("/home/amit/Desktop/HotelManagementSystem/taj.webp")
        img5=img5.resize((200,120),Image.ANTIALIAS)
        self.photoimg5=ImageTk.PhotoImage(img5)

        lblimg=Label(self.root,image=self.photoimg5,bd=4,relief=RIDGE)
        lblimg.place(x=0,y=0,width=200,height=120)
        #===================title==============================
        ...
        #======================right image=========================
        img2=Image.open("/home/amit/Desktop/HotelManagementSystem/taj3.jpg")
        ...
        img3=Image.open("/home/amit/Desktop/HotelManagementSystem/tajj.jpg")
        ...
        img4=Image.open("/home/amit/Desktop/HotelManagementSystem/tajj.jpg")
